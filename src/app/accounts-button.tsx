...
export function AccountsButton({ banks, current, action }: Props) {
  ...
  return (
    <>
      <button
        ...
        className="w-50 mt-7 block mx-auto flex items-center justify-center gap-2 rounded-2xl bg-white/10 backdrop-blur-sm text-white/80 text-sm font-medium py-2.5 hover:bg-white/15 transition-colors cursor-pointer"
      >
