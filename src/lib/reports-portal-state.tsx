...
export type ReportTab = "rapporten" | "trends" | "vermogen" | "prognose";

interface Ctx {
  open: boolean;
  everOpened: boolean;
  activeTab: ReportTab;
  /** Opens the Analytics portal, optionally jumping straight to a given tab. */
...
// open the same Analytics portal as the header's chart icon — and land on a specific
